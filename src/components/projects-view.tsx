...
import { CalendarDays, Grid2X2, List, MapPin, Plus, Search, Trash2 } from "lucide-react";
...
export function ProjectsView() {
  ...
  return <><div className="mb-5 flex flex-col gap-3 rounded-xl border border-slate-200 bg-white p-3 shadow-sm sm:flex-row sm:items-center">
    ...
    <div className="flex rounded-lg border border-slate-200 p-1"><Button onClick={() => setView("grid")} variant={view === "grid" ? "secondary" : "ghost"} size="icon" className="size-8"><Grid2X2 className="size-4" /></Button><Button onClick={() => setView("table")} variant={view === "table" ? "secondary" : "ghost"} size="icon" className="size-8"><List className="size-4" /></Button></div>
